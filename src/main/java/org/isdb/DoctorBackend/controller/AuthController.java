...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody RegisterRequest registerRequest) {
		try {
			User user = new User(registerRequest.usersname(), registerRequest.email(), registerRequest.password(),
					registerRequest.role(), registerRequest.gender(), registerRequest.age(),
			...
			userResponse.setUsername(savedUser.getUsersName());
	...
	public ResponseEntity<?> authenticateUser(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			userData.put("usersName", user.getUsersName());
	...
	public ResponseEntity<?> validateToken(HttpServletRequest request) {
		...
		if (jwt != null && jwtTokenProvider.validateToken(jwt)) {
			...
			userResponse.setUsername(user.getUsersName());
